...
export class NotificationMapper {
  public static toTypeORM(notification: Notification): NotificationTypeORM {
    ...
    notificationTypeORM.idContractor = IdContractorTypeORM.from(notification.getIdContractor().getValue());
    notificationTypeORM.idEmployee = IdEmployeeTypeORM.from(notification.getIdEmployee().getValue());
