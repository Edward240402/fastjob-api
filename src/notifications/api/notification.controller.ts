...
export class NotificationsController {
  ...
  async register(
    ...
    try {
      const result: Result<AppNotification, RegisterNotificationResponseDto> = await this.notificationsApplicationService.register(registerNotificationRequestDto);
      if (result.isSuccess()) {
